...
package carpet.forge.core.config;
...
import static carpet.forge.core.config.Property.Type.BOOLEAN;
import static carpet.forge.core.config.Property.Type.DOUBLE;
import static carpet.forge.core.config.Property.Type.INTEGER;
import static carpet.forge.core.config.Property.Type.STRING;
...
public class Configuration
{
    ...
    private void runConfiguration(File file, String configVersion)
    {
        ...
        else
        {
            ...
            catch (Throwable e)
            {
                ...
                CarpetCore.log.fatal("An exception occurred while loading config file {}. This file will be renamed to {} " +
    ...
    public void load()
    {
        ...
        {
            CarpetCore.log.error("Error while loading config {}.", fileName, e);
        }
        finally
        {
    ...
    public float getFloat(String name, String category, float defaultValue, float minValue, float maxValue, String comment, String langKey)
    {
        ...
        {
            CarpetCore.log.error("Failed to get float for {}/{}", name, category, e);
        }
        return defaultValue;
    }
