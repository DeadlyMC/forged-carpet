...
// Helper class for accurateBlockPlacement.
// Credits: masa (Tweakeroo)
// https://github.com/maruohon/tweakeroo/blob/forge_1.12.2/src/main/java/fi/dy/masa/tweakeroo/tweaks/PlacementHandler.java
public class PlacementHandler
{
    public static IBlockState getStateForPlacement(IBlockState stateIn, UseContext context)
    {
        ...
        @Nullable PropertyDirection property = getFirstDirectionProperty(stateIn);
        int x = (int) hitVec.x;
    ...
    // Credits: masa (Malilib)
    // https://github.com/maruohon/malilib/blob/forge_1.12.2/src/main/java/fi/dy/masa/malilib/util/BlockUtils.java#L19-L36
    @Nullable
